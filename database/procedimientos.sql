...
--Listar clientes
CREATE OR REPLACE PROCEDURE GET_CLIENTES (
...
CREATE OR REPLACE PROCEDURE REPORTE_INVENTARIO (
    C_INV OUT SYS_REFCURSOR
)
AS
BEGIN
    OPEN C_INV FOR
